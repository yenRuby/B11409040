        ...
        const domElements = ['chat-container', 'text-input', 'send-btn', 'mic-btn', 'input-area', 'voice-select', 'quick-actions', 'mode-dropdown', 'btn-original', 'game-dashboard', 'game-zone-btn', 'controls-area', 'namePromptModal', 'titlePromptModal', 'sheepCountModal', 'natureSoundModal', 'questionPromptModal', 'gomokuModal', 'rpsModal', 'carModal', 'birdModal', 'namePromptInput', 'sheepCountInput', 'questionPromptInput', 'gomoku-setup', 'gomoku-game-area', 'gomoku-info', 'gomoku-mode-display', 'gomokuCanvas', 'carCanvas', 'birdCanvas', 'car-score', 'car-start-screen', 'car-over-screen', 'car-final-score', 'bird-score', 'bird-start-screen', 'bird-over-screen', 'bird-final-score', 'rps-status', 'rps-result'];
        const document = {
            getElementById: id => {
                if (id === 'birdCanvas' || id === 'carCanvas' || id === 'gomokuCanvas') {
                    return { getContext: () => ({ clearRect: ()=>{}, fillStyle: '', fillRect: ()=>{}, strokeStyle: '', setLineDash: ()=>{}, lineDashOffset: 0, lineWidth: 0, beginPath: ()=>{}, moveTo: ()=>{}, lineTo: ()=>{}, stroke: ()=>{}, font: '', textAlign: '', textBaseline: '', fillText: ()=>{}, save: ()=>{}, translate: ()=>{}, rotate: ()=>{}, restore: ()=>{}, arc: ()=>{}, fill: ()=>{} }), addEventListener: ()=>{}, getBoundingClientRect: ()=>({ left: 0, top: 0 }) };
                }
                return domElements.includes(id) ? { style: {}, classList: { add: ()=>{}, remove: ()=>{} }, value: '', addEventListener: ()=>{}, innerHTML: '', appendChild: ()=>{} } : null;
            },
            querySelectorAll: () => [],
        ...
        const window = { location: { href: '' }, AudioContext: function(){ this.state='running'; this.resume=()=>{}; } };
        ...
        const initialAudio = "/static/audio/voice_fa267366-b577-436f-a856-8f5c2e92e9cf.mp3";
